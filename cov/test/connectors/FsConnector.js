...
(function() {
  ...
  describe('the fsConnector,', function() {
    describe('when being constructed', function() {
      return it('should set the prefix to domain/resource', function(done) {
        ...
        return instance = new FsConnector(params, {
          fs: NodePersistMock
        });
      });
    });
    return describe('when creating a new file', function(done) {
